...
/**
 * Render text at the specified position with scaling
 *
 * @param font Bitmap font to use
 * @param graphics_context Graphics context for rendering
 ...
 * @param y Y position to render at
 * @param color Font color to use
 * @param scale Scale factor (2 = 2x size, 3 = 3x size, etc.)
 */
...
/**
 * Get the width in pixels of the rendered text with scaling
 *
 * @param font Bitmap font to measure with
 * @param text Text string to measure
